...
this read me describes how the run_analysis code works:

Reading in the data:

The code starts off by downloading the data files from the url : "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip", if not already downloaded.

The code then unzips and reads in the files before carrying ou the transformations described below:
...
DATA: copied from the original readme document provided.
==================================================================
...
Feature Selection (copied from the original features script provided)
=================
